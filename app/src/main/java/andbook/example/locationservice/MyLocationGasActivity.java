...
public class MyLocationGasActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mygas);
        Button connect_GAS_Btn = (Button) findViewById(R.id.contact_gas);

        GpsCheck.checkGPS_ON_OFF(MyLocationGasActivity.this); // GPS 확인 유무
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.gasMap);

        if (mapFragment != null) {
            mapFragment.getMapAsync(MyLocationGasActivity.this);
        }
        ...
        connect_GAS_Btn .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                new NRPlaces.Builder()
                        .listener(MyLocationGasActivity.this)
